...
const ChurchForm = () => {
  ...
  const getData = async () => {
    ...
    data1[0].zipcode = data1[0].zipcode.substr(0, 3) + '-' + data1[0].zipcode.substr(3)
  ...
  const handleZip = (e) => {
    ...
    if (data === 6) e.target.value = e.target.value.substr(0, 3) + '-' + e.target.value.substr(3)
  }
